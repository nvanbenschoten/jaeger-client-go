...
// Deprecated: Use NewSimpleService instead
...
func (p *SimpleServiceClient) Call(ctx context.Context, arg *Data) (r *Data, err error) {
  ...
  if err = p.c.Call(ctx, "Call", &_args0, &_result1); err != nil {
    return
  }
...
func (p *SimpleServiceClient) Simple(ctx context.Context) (err error) {
  ...
  if err = p.c.Call(ctx, "Simple", &_args2, &_result3); err != nil {
    return
  }
  switch {
...
func (p *SimpleServiceClient) SimpleFuture(ctx context.Context) (err error) {
  ...
  if err = p.c.Call(ctx, "SimpleFuture", &_args4, &_result5); err != nil {
    return
  }
  switch {
...
// Deprecated: Use NewSecondService instead
...
func (p *SecondServiceClient) Echo(ctx context.Context, arg string) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "Echo", &_args14, &_result15); err != nil {
    return
  }
