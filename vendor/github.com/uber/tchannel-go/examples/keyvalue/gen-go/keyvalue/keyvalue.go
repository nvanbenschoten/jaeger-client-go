...
func (p *BaseServiceClient) HealthCheck(ctx context.Context) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "HealthCheck", &_args0, &_result1); err != nil {
    return
  }
...
// Deprecated: Use NewKeyValue instead
...
func (p *KeyValueClient) Get(ctx context.Context, key string) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "Get", &_args4, &_result5); err != nil {
    return
  }
  switch {
...
func (p *KeyValueClient) Set(ctx context.Context, key string, value string) (err error) {
  ...
  if err = p.c.Call(ctx, "Set", &_args6, &_result7); err != nil {
    return
  }
  switch {
...
// Deprecated: Use NewAdmin instead
...
func (p *AdminClient) ClearAll(ctx context.Context) (err error) {
  ...
  if err = p.c.Call(ctx, "clearAll", &_args12, &_result13); err != nil {
    return
  }
  switch {
