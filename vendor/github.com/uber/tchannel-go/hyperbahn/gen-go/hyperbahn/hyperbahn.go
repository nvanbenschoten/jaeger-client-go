...
type Hyperbahn interface {
  // Parameters:
  //  - Query
  Discover(ctx context.Context, query *DiscoveryQuery) (r *DiscoveryResult_, err error)
}
...
// Deprecated: Use NewHyperbahn instead
...
// Parameters:
//  - Query
func (p *HyperbahnClient) Discover(ctx context.Context, query *DiscoveryQuery) (r *DiscoveryResult_, err error) {
  var _args1 HyperbahnDiscoverArgs
  _args1.Query = query
  var _result2 HyperbahnDiscoverResult
  if err = p.c.Call(ctx, "discover", &_args1, &_result2); err != nil {
    return
  }
  switch {
  case _result2.NoPeersAvailable!= nil:
    return r, _result2.NoPeersAvailable
  case _result2.InvalidServiceName!= nil:
    return r, _result2.InvalidServiceName
  }
