...
func (s *httpBaggageRestrictionManagerProxy) GetBaggageRestrictions(_ context.Context, serviceName string) ([]*thrift.BaggageRestriction, error) {
...
func (m *RestrictionManager) updateRestrictions() error {
	restrictions, err := m.thriftProxy.GetBaggageRestrictions(context.TODO(), m.serviceName)
	if err != nil {
