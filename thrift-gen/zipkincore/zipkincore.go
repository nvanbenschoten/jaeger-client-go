...
func (p *ZipkinCollectorClient) SubmitZipkinBatch(ctx context.Context, spans []*Span) (r []*Response, err error) {
  var _args2 ZipkinCollectorSubmitZipkinBatchArgs
  _args2.Spans = spans
  var _result3 ZipkinCollectorSubmitZipkinBatchResult
  if err = p.c.Call(ctx, "submitZipkinBatch", &_args2, &_result3); err != nil {
    return
  }
