...
type SamplingManager interface {
  // Parameters:
  //  - ServiceName
  GetSamplingStrategy(ctx context.Context, serviceName string) (r *SamplingStrategyResponse, err error)
}
...
// Deprecated: Use NewSamplingManager instead
...
func (p *SamplingManagerClient) GetSamplingStrategy(ctx context.Context, serviceName string) (r *SamplingStrategyResponse, err error) {
  var _args1 SamplingManagerGetSamplingStrategyArgs
  _args1.ServiceName = serviceName
  var _result2 SamplingManagerGetSamplingStrategyResult
  if err = p.c.Call(ctx, "getSamplingStrategy", &_args1, &_result2); err != nil {
    return
  }
